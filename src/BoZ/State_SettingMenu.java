...
public class State_SettingMenu extends IState {
	Texture m_Back;
	public Man_Cube_Setting m_Box;
	
	public State_SettingMenu(IPlay _Play) {
		super(_Play);
		m_IDState=DefineCons.STATE_SETTING;
		m_Box = new Man_Cube_Setting();
	}
	
	 public void Init (){
		 m_Back=LoadTexture("Image/Setting_Screen.png");
		 m_Back.enable();
		 m_Box.Init();
		 m_Box.m_TestCome = true;
	    }
